 ...
 */
public class IsNotNullRuleParser extends AbstractArangoQueryRuleParser {
	public boolean canParse(IRule rule) {
        return EnumOperator.IS_NOT_NULL.equals(rule.getOperator());
    }

    public AqlOperation parse(IRule rule, JsonRuleParser parser) {
        return new AqlOperation( documentField(rule.getField()).append(" != null ") );
    }
}
